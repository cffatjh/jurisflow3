...
// Template categories
const CATEGORIES = [
    { value: 'petition', label: 'Dilekçe / Petition' },
    { value: 'contract', label: 'Sözleşme / Contract' },
    { value: 'notice', label: 'İhtarname / Notice' },
    { value: 'power_of_attorney', label: 'Vekaletname / Power of Attorney' },
    { value: 'agreement', label: 'Protokol / Agreement' },
    { value: 'letter', label: 'Mektup / Letter' },
    { value: 'other', label: 'Diğer / Other' },
];

// Common variables that can be used in templates
const COMMON_VARIABLES: VariableDefinition[] = [
    { name: 'client_name', label: 'Müvekkil Adı / Client Name', type: 'text', required: true },
    { name: 'client_address', label: 'Müvekkil Adresi / Client Address', type: 'text' },
    { name: 'client_tc', label: 'TC Kimlik No / ID Number', type: 'text' },
    { name: 'opponent_name', label: 'Karşı Taraf / Opponent Name', type: 'text' },
    { name: 'case_number', label: 'Dosya No / Case Number', type: 'text' },
    { name: 'court_name', label: 'Mahkeme / Court Name', type: 'text' },
    { name: 'date', label: 'Tarih / Date', type: 'date', required: true },
    { name: 'amount', label: 'Tutar / Amount', type: 'number' },
    { name: 'attorney_name', label: 'Avukat Adı / Attorney Name', type: 'text' },
    { name: 'bar_number', label: 'Baro Sicil No / Bar Number', type: 'text' },
];
                                ...
                                {previewMode ? (
                                    <div className="flex-1 border border-gray-200 rounded-lg p-4 bg-gray-50 overflow-y-auto">
                                        <div className="prose prose-sm max-w-none whitespace-pre-wrap">
                                            {formData.content
                                                .replace(/\{\{client_name\}\}/g, '<span class="bg-yellow-100 px-1 rounded">Ahmet Yılmaz</span>')
                                                .replace(/\{\{date\}\}/g, '<span class="bg-yellow-100 px-1 rounded">' + new Date().toLocaleDateString('tr-TR') + '</span>')
