...
const ForgotPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage('Eğer bu email adresi kayıtlıysa, şifre sıfırlama bağlantısı gönderildi. Lütfen email kutunuzu kontrol edin.');
    } catch (err: any) {
    ...
    <div className="min-h-screen w-full flex flex-col justify-center items-center bg-white relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md px-6 py-8">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-800 mb-2">Şifre Sıfırlama</h1>
          <p className="text-gray-600">Email adresinize şifre sıfırlama bağlantısı göndereceğiz</p>
        </div>
            ...
            <div className="flex gap-4">
              <label className="flex items-center">
                <input
                  ...
                  className="mr-2"
                />
                <span className="text-sm text-gray-700">Avukat</span>
              </label>
              <label className="flex items-center">
                <input
                  type="radio"
                  ...
                  className="mr-2"
                />
                <span className="text-sm text-gray-700">Müvekkil</span>
              </label>
            </div>
          </div>
