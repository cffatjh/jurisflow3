...
import { CheckSquare, Plus, Filter, X } from './Icons';
import { useTranslation } from '../contexts/LanguageContext';
import { useData } from '../contexts/DataContext';

const Tasks: React.FC = () => {
  const { t, formatDate } = useTranslation();
  const { tasks, addTask, updateTaskStatus, matters, taskTemplates, createTasksFromTemplate } = useData();
                                  ...
                                  return (
                                    <div
                                      ...
                                      className={`bg-white p-4 rounded-lg shadow-sm border border-gray-200 group hover:shadow-md transition-all ${
                                        highlightTaskId === task.id ? 'ring-2 ring-indigo-400 border-indigo-200' : ''
                                      }`}
                                    >
